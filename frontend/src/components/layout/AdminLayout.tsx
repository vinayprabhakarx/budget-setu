  ...
  return (
    <div className="min-h-screen bg-bg-base text-text-primary flex overflow-x-hidden relative w-full">
      ...
      <header className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-bg-surface border-b border-border z-50 flex items-center justify-between px-4 shadow-sm">
        <Link to="/dashboard" className="font-display text-text-primary text-2xl font-medium tracking-tight select-none flex items-center gap-2">
          <span>BudgetSetu</span>
          <span className="ml-1 text-lg font-bold text-brand font-sans" title="Beta">
            β
          </span>
        </Link>
      ...
      <header className="hidden lg:flex items-center justify-between h-16 w-full fixed top-0 left-0 bg-bg-surface border-b border-border px-8 z-40 shadow-sm">
        <Link to="/dashboard" className="font-display text-text-primary text-2xl lg:text-3xl tracking-tight select-none flex items-center gap-2">
          <span>BudgetSetu</span>
          <span className="ml-1 text-xl font-bold text-brand font-sans" title="Beta">
            β
          </span>
        </Link>
      </header>
