 ...
 * Implementations must follow the canonical extraction rules defined in StatementParser.md.
 */
public interface BankStatementParser {
     ...
     * @return list of parsed transactions matching the canonical schema, or empty list if format doesn't match
     */
