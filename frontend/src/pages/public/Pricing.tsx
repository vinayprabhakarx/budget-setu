  ...
  return (
    <PublicLayout>
      <div className="relative overflow-hidden py-24 md:py-32">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-brand/20 blur-[120px] rounded-full opacity-50 pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 space-y-20">
          ...
          <div className="text-center space-y-6 max-w-2xl mx-auto">
            ...
            <p className="text-text-secondary text-body-lg leading-relaxed">
              ...
              absolute cashflow clarity. No hidden subscriptions, no ads, no paywalls.
            </p>
          </div>
