 ...
 * Handles the uploading, parsing, and processing of bank statements (CSV/PDF) and tracks import job statuses.
 */
public class ImportController {
    ...
    public ResponseEntity<com.budgetsetu.dto.response.ImportDetailsResponse> getDetails(@AuthenticationPrincipal UUID userId, @PathVariable UUID importId) {
    ...
    public org.springframework.web.servlet.mvc.method.annotation.SseEmitter streamStatus(@AuthenticationPrincipal UUID userId,
                                                        @PathVariable UUID importId) {
