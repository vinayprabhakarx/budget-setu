...
public class GooglePayParser extends BaseBankParser {
    ...
    public List<Map<String, String>> parseText(String text, String fileName) {
        ...
        for (List<String> block : blocks) {
            ...
            if (gpayAmt.find() && (
                ...
                Matcher paidByMatcher = Pattern.compile("(Paid by|Credited to|Deposited to)\\s+([^₹]+)").matcher(fullText);
    ...
    public boolean canHandle(String text, String fileName) {
        ...
        return text.contains("payments made by you on the Google Pay app") || (fileName != null && fileName.toLowerCase().contains("gpay"));
    }
