...
export const DashboardSummarySkeleton: React.FC = () => (
  <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
    ...
    <CardSkeleton title="Total Income" icon={<ArrowUpRight className="h-5 w-5" />} />
    <CardSkeleton title="Total Expenses" icon={<ArrowDownRight className="h-5 w-5" />} />
...
export const DashboardChartsSkeleton: React.FC = () => (
  <section className="grid grid-cols-1 lg:grid-cols-12 gap-6">
    ...
    <div className="card lg:col-span-5 flex flex-col min-h-[22.5rem] p-6">
      <h3 className="font-semibold text-text-primary text-heading-sm mb-4">Spending by Category</h3>
    ...
    <div className="card lg:col-span-7 flex flex-col min-h-[22.5rem] p-6">
      <h3 className="font-semibold text-text-primary text-heading-sm mb-4">6-Month Trend</h3>
...
export const DashboardActiveBudgetsSkeleton: React.FC = () => (
  <section className="space-y-4">
    <h3 className="font-semibold text-text-primary text-heading-sm">Active Budget Plans</h3>
...
export const DashboardBudgetsSkeleton: React.FC = () => (
  <section className="space-y-4">
    <h3 className="font-semibold text-text-primary text-heading-sm">Category Budgets</h3>
...
export const DashboardTransactionsSkeleton: React.FC = () => (
  <section className="card p-6 space-y-4">
    ...
    <div className="flex items-center justify-between mb-2">
      <h3 className="font-semibold text-text-primary text-heading-sm">Recent Transactions</h3>
    </div>
    {/* Table skeleton */}
    <TableSkeleton headers={["Date", "Description", "Category", "Amount"]} rows={5} />
  </section>
);
