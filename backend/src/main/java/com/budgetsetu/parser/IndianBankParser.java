...
public class IndianBankParser extends BaseBankParser {
    ...
    public List<Map<String, String>> parseText(String text, String fileName) {
        ...
        for (List<String> block : blocks) {
            ...
            // Re-join from original block to preserve structure if possible, but fullText is already space joined.
            ...
            // Parse Indian Bank Narration: {bank_code}/{counterparty_name}/{masked_account}/...
